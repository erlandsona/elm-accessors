...
-}
at : TreePath -> Traversal a a x y -> Traversal (Tree a) (Tree a) x y
at p =
    path p << label_
...
-}
label_ : Lens ls a a x y -> Lens ls (Tree a) (Tree a) x y
label_ =
    Base.lens "-label"
        Tree.label
...
-}
path : TreePath -> Traversal (Tree a) (Tree a) x y -> Traversal (Tree a) (Tree a) x y
path p =
    Base.traversal
...
-}
each : Traversal a b x y -> Traversal (Tree a) (Tree b) x y
each =
